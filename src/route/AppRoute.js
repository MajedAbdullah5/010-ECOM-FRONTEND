        ...
        return (
            <Fragment>
                <Switch>
                    ...
                    <Route exact path="/ProductListByCategory/:Category"
                           render={(props) => <ProductListByCategory {...props} key={Date.now()}/>}/>
                    <Route exact path="/ProductListBySubCategory/:Category/:SubCategory"
                           render={(props) => <ProductListBySubCategory {...props} key={Date.now()}/>}/>
                    <Route exact path="/ProductSearch/:key"
                           render={(props) => <SearchResult {...props} key={Date.now()}/>}/>
                </Switch>
            </Fragment>
        );
    }
