                            ...
                            <Row className="text-center">
                                <Col className="d-flex justify-content-center my-5" lg={6} md={6} xs={12} sm={12}>
                                    <Form className="onboardForm ">
                                        ...
                                        <h6 className="section-sub-title mb-5">Please Enter Your Mobile No, And Go
                                            Next</h6>
                                        <input id="inp" onChange={this.onChange}
                                               className="form-control section-sub-title m-2"
                                               type="text" placeholder={this.state.placeholder}/>
                                        <Button onClick={this.onClick}
                                                className="btn btn-block m-2 site-btn">Next</Button>
                                    </Form>
                                </Col>
