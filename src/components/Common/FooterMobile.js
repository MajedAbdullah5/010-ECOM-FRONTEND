        ...
        if(GetSiteInfoFooter == null){
            axios.get(ApiURL.SendSiteInfo).then(response=>{
                if(response.status == 200){
                    ...
                    sessionStorage.setItem("SiteInfoFooter",JSON.stringify(SetSiteInfoFooter));
                    this.setState({
                        ...
                        <Container fluid={true}>
                            <Row className="px-0 mx-5 my-5">
                                <Col className="p-2" lg={3} md={3} sm={6} xs={12}>
                                    ...
                                    <p className="footer-link">{ReactHtmlParser(this.state.address)}</p>
                                ...
                                <Col className="p-2">
                                    ...
                                    <p className="footer-link">{ReactHtmlParser(this.state.address)}</p><br/>
                                </Col>
                                <Col className="p-2">
                                ...
                                <Col className="p-2">
                                    ...
                                    <a target="_blank" href={this.state.iosLink}><img className="my-2" src="Images/Android.png"
                                                                                      alt="ANDROID"/></a><br/>
                                    <a target="_blank" href={this.state.androidLink}><img className="h-25 w-25" src="Images/Apple.png" alt="IOS"/></a>
                            ...
                            <Row>
                                <Col className="w-100 bg-dark ">
                                    ...
                                    <p className="text-white footer-text">{ReactHtmlParser(this.state.deliveryNotice)}</p>
                                </Col>
                            </Row>
                        </Container>
                    </div>
